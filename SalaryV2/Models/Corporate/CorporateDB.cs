namespace SalaryV2.Models.Corporate
{
    ...
    public partial class CorporateDB : DbContext
    {
        public CorporateDB()
            : base("name=CorporateDB")
        {
        }
        ...
        public virtual DbSet<vwTaxTable> vwTaxTables { get; set; }
        public virtual DbSet<vwTaxTableItem> vwTaxTableItems { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<vwBranch>()
                .Property(e => e.BranchCode)
                .IsUnicode(false);

            modelBuilder.Entity<vwBranch>()
                .Property(e => e.CostCenterDLCode)
                .IsUnicode(false);
            ...
            modelBuilder.Entity<vwTaxTableItem>()
