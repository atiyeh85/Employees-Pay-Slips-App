...
namespace Salaryv2.Controllers
{
    public class RandomNumController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RandId,SequrityCode,NationCode,Mobile,acnt,ComputerName,Date,Time,EditDate,EditTime,Lname,Fname,Father")] RandomNumber randomNumber)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RandId,SequrityCode,NationCode,Mobile,acnt,ComputerName,Date,Time,EditDate,EditTime,Lname,Fname,Father")] RandomNumber randomNumber)
        {
            if (ModelState.IsValid)
            {
