...
namespace Salaryv2.Parsasms {
    ...
    public partial class v2 : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback GetReceiveMessages2OperationCompleted;
        ...
        /// <remarks/>
        public v2() {
            this.Url = global::Salaryv2.Properties.Settings.Default.Salaryv2_Parsasms_v2;
        ...
        /// <remarks/>
        public event GetReceiveMessages2CompletedEventHandler GetReceiveMessages2Completed;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/GetReceiveMessages2", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public ReciveMessageViewModel[] GetReceiveMessages2(string username, string password, string destNumber, int isRead) {
            object[] results = this.Invoke("GetReceiveMessages2", new object[] {
                        username,
                        password,
                        destNumber,
                        isRead});
            return ((ReciveMessageViewModel[])(results[0]));
        }
        
        /// <remarks/>
        public void GetReceiveMessages2Async(string username, string password, string destNumber, int isRead) {
            this.GetReceiveMessages2Async(username, password, destNumber, isRead, null);
        }
        
        /// <remarks/>
        public void GetReceiveMessages2Async(string username, string password, string destNumber, int isRead, object userState) {
            if ((this.GetReceiveMessages2OperationCompleted == null)) {
                this.GetReceiveMessages2OperationCompleted = new System.Threading.SendOrPostCallback(this.OnGetReceiveMessages2OperationCompleted);
            }
            this.InvokeAsync("GetReceiveMessages2", new object[] {
                        username,
                        password,
                        destNumber,
                        isRead}, this.GetReceiveMessages2OperationCompleted, userState);
        }
        
        private void OnGetReceiveMessages2OperationCompleted(object arg) {
            if ((this.GetReceiveMessages2Completed != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.GetReceiveMessages2Completed(this, new GetReceiveMessages2CompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://tempuri.org/")]
    public partial class ReciveMessageViewModel {
        ...
        private System.DateTime receiveDateOriginalField;
        ...
        /// <remarks/>
        public System.DateTime ReceiveDateOriginal {
            get {
                return this.receiveDateOriginalField;
            }
            set {
                this.receiveDateOriginalField = value;
            }
        }
    }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.3752.0")]
    public delegate void GetReceiveMessages2CompletedEventHandler(object sender, GetReceiveMessages2CompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.3752.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class GetReceiveMessages2CompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal GetReceiveMessages2CompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
        
        /// <remarks/>
        public ReciveMessageViewModel[] Result {
            get {
                this.RaiseExceptionIfNecessary();
                return ((ReciveMessageViewModel[])(this.results[0]));
            }
        }
    }
